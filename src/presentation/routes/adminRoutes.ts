...
router.put(
  "/beneficiaries/block/:id",
  authMiddleware,
  beneficiaryController.blockBeneficiary
);
router.put(
  "/beneficiaries/unblock/:id",
  authMiddleware,
  beneficiaryController.unblockBeneficiary
);
router.get(
  "/beneficiary/edit/:id",
  authMiddleware,
...
router.put(
  "/volunteers/block/:id",
  authMiddleware,
  volunteerController.blockVolunteer
);
router.put(
  "/volunteers/unblock/:id",
  authMiddleware,
  volunteerController.unblockVolunteer
);
router.get(
  "/volunteers/edit/:id",
  authMiddleware,
...
router.put(
  ...
  authMiddleware,
  volunteerController.editVolunteer
);

router.get("/donors", authMiddleware, (req, res) =>
  donorController.getAllDonors(req, res)
);
...
router.get("/reports", authMiddleware, (req, res) =>
  adminController.getDonationReport(req, res)
);
