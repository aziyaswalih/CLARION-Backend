...
export class VolunteerController {
    static async addVolunteer(req: Request, res: Response) {
        try {
            ...
            res.status(HttpStatus.CREATED).json({ success: true, message: "Volunteer added successfully", data: volunteer });
        } catch (error:any) {
            console.error("Error adding volunteer:", error);
            res.status(HttpStatus.INTERNAL_SERVER_ERROR).json({ success: false, message: "Failed to add volunteer", error: error.message });
        }
    }
    ...
    static async getVolunteers(req: Request, res: Response) {
        try {
            ...
            res.status(HttpStatus.OK).json({ success: true, message: "Volunteers retrieved successfully", data: volunteers });
        } catch (error:any) {
            console.error("Error fetching volunteers:", error);
            res.status(HttpStatus.INTERNAL_SERVER_ERROR).json({ success: false, message: "Failed to fetch volunteers", error: error.message });
        }
    }
    ...
    static async getVolunteerById(req: Request, res: Response) {
        try {
            ...
            res.status(HttpStatus.OK).json({ success: true, message: "Volunteer retrieved successfully", data: volunteer });
        } catch (error:any) {
    ...
    static async deleteVolunteer(req: Request, res: Response) {
        try {
            ...
            res.status(HttpStatus.OK).json({ success: true, message: "Volunteer deleted successfully" });
        } catch (error:any) {
            console.error("Error deleting volunteer:", error);
            res.status(HttpStatus.INTERNAL_SERVER_ERROR).json({ success: false, message: "Failed to delete volunteer", error: error.message });
        }
    }
}
